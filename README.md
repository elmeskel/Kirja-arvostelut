...
Käyttäjä pystyy etsimään arvosteluita kirjan nimellä. 
...
Käyttäjä pystyy valitsemaan kirjalle yhden tai useamman luokittelun (genre: dekkari, kauhu jne.; kohdelyleisö: lapset, nuoret, aikuiset). Mahdolliset luokittelut ovat tietokannassa.
Pääasiallinen tietokohde on kirja ja toissijainen tietokohde arvostelu
